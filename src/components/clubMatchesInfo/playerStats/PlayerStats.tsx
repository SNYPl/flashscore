        ...
        <div className={`${style.infoItemSection} `}>
          ...
          >
            <div className=" flex items-center">
              ...
              <h3 className={`${style.infoTitle} font-semibold `}>
                Jude Bellingham
              </h3>
            </div>
            <span className={`${style.infoNumber} font-semibold `}>18</span>
          </div>
          <div
            className={`${style.seeAllBtn}  flex justify-center items-center `}
          >
